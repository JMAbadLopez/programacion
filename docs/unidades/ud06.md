...
@Override
public int compareTo(Personaje o) {
    // Opción A: Resta (Cuidado con desbordamientos en números muy grandes)
    // return this.nivel - o.nivel; 

    // Opción B: Usar el helper de la clase wrapper (Recomendado)
    return Integer.compare(this.nivel, o.nivel); // Orden Ascendente (1, 2, 3...)
    
    // Truco: Para Orden Descendente (3, 2, 1...), invierte los parámetros:
