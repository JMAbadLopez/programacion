...
Imagina un método que calcula si un golpe es crítico. Solo la clase `Personaje` debe usarlo cuando recibe daño; nadie desde fuera debería poder llamar a `calcularCritico()` directamente.
...
public class Personaje {
    ...
    public void recibirDano(int puntos) {
        ...
        if (this.vida < 0) {
            this.vida = 0;
            System.out.println("[MUERTE] " + this.nombre + " ha sido derrotado.");
        } else {
            System.out.println("[DAÑO] " + this.nombre + " recibe " + puntos + " daño. Vida: " + this.vida);
        }
    }

    // 3. GETTERS Y SETTERS (La Interfaz Pública)
...
public class Personaje {
    ...
    public void recibirDano(int puntos) {
        ...
        System.out.println(this.nombre + " recibe daño. Vida: " + this.vida);
    }
...
public class Personaje {
    ...
    public void recibirDano(int puntos) {
        this.vida -= puntos;
        if (this.vida < 0) this.vida = 0;
        System.out.println(this.nombre + " recibe " + puntos + " daño. Vida: " + this.vida);
    }
